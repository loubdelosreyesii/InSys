...
-- --------------------------------------------------
-- Date Created: 01/15/2023 18:55:48
...
GO
IF OBJECT_ID(N'[dbo].[InventoryPriceHistories]', 'U') IS NOT NULL
    DROP TABLE [dbo].[InventoryPriceHistories];
GO
...
-- Creating table 'CapitalHistories'
CREATE TABLE [dbo].[CapitalHistories] (
    [Id] int IDENTITY(1,1) NOT NULL,
    [Amount] decimal(18,0)  NOT NULL,
    [TransactionDateTime] datetime  NOT NULL
);
...
-- Creating primary key on [Id] in table 'CapitalHistories'
ALTER TABLE [dbo].[CapitalHistories]
ADD CONSTRAINT [PK_CapitalHistories]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
